...
function assertRelativeTime(a: RelativeTime, b: RelativeTime) {
    ...
    if (a.valid !== b.valid || 
        ...
        aKeys.some(key => a.timeValues[key] !== b.timeValues[key])) {
            throw new Error(`assert failed for:\n${JSON.stringify(a)}\n${JSON.stringify(b)}`);
    }
}
...
const now = momentFrom("01/01/2025 00:00");
...
assertRelativeTime({ valid: true, date: momentFrom("01/01/2025 00:01"), timeValues: {"m": 1} }, 
        parseRelativeTime(now, "1m", tz));
assertRelativeTime({ valid: true, date: momentFrom("04/01/2025 02:01"), timeValues: {"d": 3, "h": 2, "m": 1} }, 
        parseRelativeTime(now, "3d2h1m", tz));
assertRelativeTime({ valid: true, date: momentFrom("21/02/2028 12:36"), timeValues: {"y": 3, "w": 2, "mo": 1, "d": 6, "h": 12, "m": 36} }, 
...
assertAbsoluteTime({ valid: true, date: momentFrom("05/01/2025 11:05"), isTimeInputted: true },
    parseAbsoluteTime("sun", "11:05", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("06/01/2025 11:05"), isTimeInputted: true },
    parseAbsoluteTime("Mon", "11:05", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("07/01/2025 11:05"), isTimeInputted: true },
    parseAbsoluteTime("TUE", "11:05", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("08/01/2025 11:05"), isTimeInputted: true },
    parseAbsoluteTime("wed", "11:05", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("02/01/2025 11:05"), isTimeInputted: true },
    parseAbsoluteTime("thursday", "11:05", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("03/01/2025 11:05"), isTimeInputted: true },
    parseAbsoluteTime("friday", "11:05", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("04/01/2025 11:05"), isTimeInputted: true },
    parseAbsoluteTime("sat", "11:05", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("01/01/2025 11:05"), isTimeInputted: true },
...
assertAbsoluteTime({ valid: true, date: momentFrom("02/02/2025 07:15"), isTimeInputted: true },
    parseAbsoluteTime("02/02", "7:15", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("02/02/2025 04:00"), isTimeInputted: true },
    parseAbsoluteTime("02/02", "4h", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("02/02/2025 16:00"), isTimeInputted: true },
    parseAbsoluteTime("02/02", "16h", now, tz));
assertAbsoluteTime({ valid: true, date: momentFrom("02/02/2025 17:00"), isTimeInputted: true },
    parseAbsoluteTime("02/02", "17H", now, tz));